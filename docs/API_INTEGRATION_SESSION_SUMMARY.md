...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await apiRequest<ApiResponse<T>>("/api/endpoint", { method: "GET" });
...
- Base URL: `https://mash-backend-api-production.up.railway.app/`
...
*Last Updated: November 6, 2025, 6:30 AM UTC+8*
