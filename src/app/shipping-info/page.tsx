        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          <Card>
            <CardContent className="p-6 text-center">
              <Truck className="h-8 w-8 text-[#6A994E] mx-auto mb-2" />
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <Package className="h-8 w-8 text-[#6A994E] mx-auto mb-2" />
              <h3 className="font-semibold text-gray-900 mb-1">
                Safe Packaging
              </h3>
              <p className="text-sm text-gray-600">Specially designed</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              <Shield className="h-8 w-8 text-[#6A994E] mx-auto mb-2" />
              <h3 className="font-semibold text-gray-900 mb-1">
                Freshness Guarantee
              </h3>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="border-l-4 border-[#6A994E] pl-4">
                <div className="flex items-start gap-3">
                  <Badge className="bg-[#6A994E] mt-1">Metro Manila</Badge>
                  <div>
              ...
              <div className="border-l-4 border-[#6A994E] pl-4">
                <div className="flex items-start gap-3">
                  <Badge className="bg-[#6A994E] mt-1">Luzon</Badge>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">
                      3-5 Business Days
                    </h4>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-3 border-b">
                  <span className="text-gray-600">Metro Manila</span>
                ...
                <div className="flex justify-between items-center pb-3 border-b">
                  <span className="text-gray-600">Other Luzon Areas</span>
                  <span className="font-semibold text-gray-900">₱150-200</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Visayas & Mindanao</span>
