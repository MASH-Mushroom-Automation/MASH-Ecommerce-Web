...
export default function InventoryPage() {
  const { loading, error, stockLevel, lowStockProducts, getLowStockProducts, updateStock, setStockAlert } = useInventory();
                    ...
                    {filteredProducts.length === 0 ? (
                      ...
                      filteredProducts.map((product) => (
                        ...
                        <TableCell className="hidden md:table-cell">
                          ...
                          <div className="text-xs text-gray-500">{new Date(product.lastUpdated).toLocaleTimeString()}</div>
                        </TableCell>
                        <TableCell>
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction className="bg-[#1E392A] hover:bg-[#1E392A]/90">
                                  Update Stock
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
