...
export function HeroSection({ onContinue }: HeroSectionProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#1E392A] to-[#2D5A45] text-white">
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 mr-3 text-[#6A994E] flex-shrink-0" />
              ...
              <Button
                onClick={onContinue}
                className="bg-[#6A994E] hover:bg-[#6A994E]/90 text-white h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg shadow-lg hover:shadow-xl transition-all"
              >
                Apply Now
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#6A994E]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl sm:text-3xl font-bold text-[#6A994E]">1</span>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#6A994E]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl sm:text-3xl font-bold text-[#6A994E]">2</span>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">
                Get Verified
              </h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#6A994E]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl sm:text-3xl font-bold text-[#6A994E]">3</span>
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">
                Start Selling
              </h3>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#1E392A]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                <TrendingUp className="w-7 h-7 sm:w-8 sm:h-8 text-[#1E392A]" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Grow Your Sales</h3>
            ...
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#1E392A]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Shield className="w-7 h-7 sm:w-8 sm:h-8 text-[#1E392A]" />
              </div>
            ...
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#1E392A]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Users className="w-7 h-7 sm:w-8 sm:h-8 text-[#1E392A]" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Marketing Support</h3>
              <p className="text-gray-600 text-xs sm:text-sm">
            ...
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#1E392A]/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                <Package className="w-7 h-7 sm:w-8 sm:h-8 text-[#1E392A]" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Easy Management</h3>
              <p className="text-gray-600 text-xs sm:text-sm">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-[#6A994E]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <Button
            onClick={onContinue}
            size="lg"
            className="bg-white text-[#1E392A] hover:bg-gray-100 h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg font-semibold shadow-xl"
          >
            Start Application
