            ...
            <CardContent className="prose prose-sm max-w-none text-gray-600">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  phone number, and delivery address when you create an account
                  or place an order.
                </li>
                <li>
                ...
                <li>
                  <strong>Order History:</strong> Details of products purchased,
                ...
                <li>
                  ...
                  website, including pages visited, products viewed, and
                  browsing behavior.
                </li>
              </ul>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm max-w-none text-gray-600">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Send you promotional emails and marketing communications (with
                  your consent)
                </li>
                <li>
                  Improve our website, products, and services based on user
                  feedback and behavior
                </li>
                <li>
                  Detect and prevent fraud, security issues, and technical
                  problems
                </li>
                <li>
            ...
            <CardContent className="prose prose-sm max-w-none text-gray-600">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  service providers who assist with order fulfillment, payment
                  processing, delivery, and customer support.
                </li>
                <li>
                  <strong>Grower Partners:</strong> Basic order information
                  (name, delivery address) is shared with our mushroom growers
                  to facilitate product delivery.
                </li>
                <li>
            ...
            <CardContent className="prose prose-sm max-w-none text-gray-600">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  data, such as marketing communications
                </li>
              </ul>
              <p className="mt-3">
          ...
          <Card className="bg-[#1E392A] text-white">
            <CardContent className="p-6">
              ...
              <div className="space-y-1 text-sm">
                <p>
                  Email: <strong>privacy@mash.ph</strong>
                </p>
                <p>
