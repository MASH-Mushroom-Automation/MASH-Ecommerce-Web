            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <Sheet>
                ...
                <SheetContent side="left" className="w-80 p-6 overflow-y-auto">
                  ...
                  {otherCategories.length > 0 && (
                    <div className="mb-6">
                      <h3 className="font-semibold text-foreground mb-3">Other Categories</h3>
                      <div className="space-y-2">
                        {otherCategories.map((cat) => (
                          <Link
                            key={cat.id}
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-4">
                      <Slider min={0} max={12000} step={10} value={priceRange} onValueChange={setPriceRange} className="w-full" />
                  ...
                  <div className="mb-6">
                    <h3 className="font-semibold text-foreground mb-3">Filter by Tags</h3>
                    <div className="flex flex-wrap gap-2">
                      {popularTags.map((tag) => (
                        <button
                          key={tag.value}
