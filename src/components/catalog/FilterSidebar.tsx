...
export function FilterSidebar({ onClose, isMobile = false }: FilterSidebarProps) {
  ...
  return (
    <div className={`bg-background ${isMobile ? 'h-full overflow-y-auto' : 'rounded-lg shadow-sm'} p-6`}>
      {isMobile && (
      ...
      {/* Categories */}
      <div className="mb-8">
        <h3 className="font-bold text-foreground mb-4 text-base">Categories</h3>
      ...
      {/* Growers */}
      <div className="mb-8">
        <h3 className="font-bold text-foreground mb-4 text-base">Grower</h3>
        <div className="space-y-3">
          {growers.map((grower) => (
      ...
      {/* Price Range */}
      <div className="mb-8">
        <h3 className="font-bold text-foreground mb-4 text-base">Price</h3>
