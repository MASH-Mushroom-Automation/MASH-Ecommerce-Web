...
export default function PrivacyModal({ open, defaultOpen, onOpenChange }: PrivacyModalProps) {
    return (
        <Dialog open={open} defaultOpen={defaultOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl max-w-80 w-full sm:mx-4 mx-0 bg-background rounded-lg shadow-lg overflow-auto max-h-[90vh] p-6">
                <DialogHeader>
                    <DialogTitle className="text-2xl sm:text-3xl font-bold text-foreground -mb-3">Privacy Policy</DialogTitle>
                </DialogHeader>

                <p className="text-sm text-muted-foreground mb-4">
                    Your privacy is important to us. This policy outlines how MASH collects, uses, and protects your personal information.
                </p>
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="prose prose-sm max-w-none text-muted-foreground">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li><strong>Access:</strong> Copy of the personal information we hold about you</li>
                    ...
                    <Card className="bg-primary text-primary-foreground rounded-2xl shadow-md">
                        <CardContent className="p-6">
                            ...
                            <p className="text-primary-foreground/80 mb-4">If you have any questions, concerns, or requests regarding your personal data or our Privacy Policy, please contact us:</p>
                            <div className="space-y-2 text-sm">
                                <p>📧 Email: <a href="mailto:privacy@mash.ph" className="font-medium underline">privacy@mash.ph</a></p>
                                <p>📞 Phone: <a href="tel:+639171234567" className="font-medium underline">+63 917 123 4567</a></p>
                                <p>📍 Address: <span className="font-medium">Quezon City, Metro Manila, Philippines</span></p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
