  ...
  steps: [
    {
      ...
      content: `
        <div>
          <h2 class="text-xl font-bold mb-3">🍄 Welcome to MASH Seller Center!</h2>
          <p class="mb-2">We're excited to have you here. This quick tour will help you:</p>
          ...
          <p class="mt-3 text-sm text-gray-600">⏱️ Takes about 2 minutes</p>
        </div>
      `,
      placement: 'center',
      category: TutorialCategory.GETTING_STARTED,
    ...
    },
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">📊 Your Dashboard</h3>
    ...
    },
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">📈 Key Metrics</h3>
          ...
          <p class="mt-2 text-sm text-blue-600">💡 Click any card for detailed insights</p>
        </div>
      `,
      placement: 'bottom',
      category: TutorialCategory.GETTING_STARTED,
    },
    {
      ...
      content: `
        <div>
          <h2 class="text-xl font-bold mb-3">🎉 You're All Set!</h2>
          <p class="mb-3">Great job! You now know the basics.</p>
          <div class="bg-blue-50 p-3 rounded-lg">
            <p class="font-semibold mb-2">📝 Recommended Next Steps:</p>
  ...
  steps: [
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">📊 Sales Analytics</h3>
  ...
  steps: [
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">➕ Add Your First Product</h3>
  ...
  steps: [
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">📦 Order Status Tabs</h3>
    ...
    },
    {
      ...
      content: `
        <div>
          ...
          <p class="mt-2 text-sm text-blue-600">💡 Faster processing = Happier customers!</p>
        </div>
      `,
      placement: 'left',
      category: TutorialCategory.ORDERS,
  ...
  steps: [
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">🏪 Store Profile</h3>
    ...
    },
    {
      ...
      content: `
        <div>
          <h3 class="font-semibold mb-2">⚙️ Store Setup</h3>
