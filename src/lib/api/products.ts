...
const MOCK_PRODUCTS: ProductApiResponse[] = [
  ...
  {
    id: "12",
    name: "Premium Shiitake Growing Kit",
    description:
      "Premium kit for growing flavorful shiitake mushrooms. Includes enriched substrate for better yields.",
    price: 450,
    weight: "1 kit",
    images: [
      "/placeholder.png",
  ...
  {
    id: "13",
    name: "Beginner's White Button Mushroom Kit",
    description:
      "Start your mushroom growing journey with this easy-to-use white button mushroom kit. Perfect for first-time growers!",
    price: 320,
    weight: "1 kit",
    images: [
      "/placeholder.png",
