  ...
  const fetchHeroes = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const sortedHeroes = data.data.sort((a, b) => a.displayOrder - b.displayOrder);
...
export function useFeatureSections() {
  ...
  const fetchFeatures = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        // Sort by display order
        const sortedFeatures = data.data.sort((a, b) => a.displayOrder - b.displayOrder);
  ...
  const fetchFAQs = useCallback(async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const sortedFAQs = data.data.map(category => ({
          ...category,
          questions: category.questions.sort((a, b) => a.displayOrder - b.displayOrder)
    ...
    try {
      ...
      setContent({
        ...
        challenges: {
          ...
          subtitle: 'Mushroom production in the Philippines holds immense potential, but small-scale farmers face persistent obstacles.',
          challenges: [
        ...
        solutions: {
          ...
          subtitle: 'M.A.S.H. (Mushroom Automation with Smart Hydro-environment) is an integrated ecosystem designed to solve these challenges.',
          solutions: [
            {
              id: 'solution-1',
              title: 'Automated Growing',
              description: 'An IoT-enabled chamber monitors and controls temperature, humidity, and CO₂ in real-time',
              displayOrder: 1
            },
            {
              id: 'solution-2',
        ...
        mentor: {
          ...
          subtitle: 'We are grateful for the guidance and expertise of our Thesis Adviser in bringing this project to life.',
          mentor: {
  ...
  const fetchContactContent = useCallback(async () => {
    ...
    try {
      ...
      setContent({
        ...
        businessHours: [
          { id: 'hours-mon', dayOfWeek: 'monday', openTime: '08:00', closeTime: '18:00', isClosed: false, isActive: true, displayOrder: 1, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-tue', dayOfWeek: 'tuesday', openTime: '08:00', closeTime: '18:00', isClosed: false, isActive: true, displayOrder: 2, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-wed', dayOfWeek: 'wednesday', openTime: '08:00', closeTime: '18:00', isClosed: false, isActive: true, displayOrder: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-thu', dayOfWeek: 'thursday', openTime: '08:00', closeTime: '18:00', isClosed: false, isActive: true, displayOrder: 4, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-fri', dayOfWeek: 'friday', openTime: '08:00', closeTime: '18:00', isClosed: false, isActive: true, displayOrder: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-sat', dayOfWeek: 'saturday', openTime: '09:00', closeTime: '16:00', isClosed: false, isActive: true, displayOrder: 6, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
          { id: 'hours-sun', dayOfWeek: 'sunday', openTime: '00:00', closeTime: '00:00', isClosed: true, isActive: true, displayOrder: 7, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
        ],
        socialLinks: [
          { id: 'social-fb', platform: 'facebook', url: 'https://facebook.com/mash.ph', displayOrder: 1, isActive: true },
          { id: 'social-insta', platform: 'instagram', url: 'https://instagram.com/mash.ph', displayOrder: 2, isActive: true },
          { id: 'social-twitter', platform: 'twitter', url: 'https://twitter.com/mash.ph', displayOrder: 3, isActive: true }
        ]
      });
    } catch (err) {
