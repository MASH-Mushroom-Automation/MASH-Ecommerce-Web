...
const banners = [
  {
    ...
    description: 'Celebrate the holidays with farm-fresh mushrooms. Perfect for your festive meals!',
  ...
  },
  {
    ...
    subheadline: 'Introducing Kalinga Mountain Farms - Premium Highland Mushrooms',
    description: 'Discover unique mushroom varieties from the mountain regions. Organic and sustainably grown.',
  ...
  },
  {
    ...
    description: 'Our easy-to-use growing kits make mushroom cultivation fun and rewarding. Harvest in just 2 weeks!',
    position: 'shop-top',
    size: 'medium',
...
async function migrateBanners() {
  ...
  for (const banner of banners) {
    try {
      ...
      const existing = await client.fetch(existingQuery, { title: banner.title });
      ...
      console.error(`❌ Error creating banner "${banner.title}":`, error.message);
      errorCount++;
    }
  }
  ...
  console.log(`   ⏭️  Skipped (existing): ${banners.length - successCount - errorCount}`);
